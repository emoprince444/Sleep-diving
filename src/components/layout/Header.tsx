    ...
    <header className="sticky top-0 z-40 border-b border-sd-line bg-white/95 shadow-[0_1px_0_rgba(24,33,45,0.03)] backdrop-blur">
      <div className="mx-auto flex h-[68px] max-w-[1640px] items-center justify-between px-8 max-lg:px-5 max-sm:h-[60px] max-sm:px-4">
        <div className="flex min-w-0 items-center gap-10 xl:gap-12">
          <a href="/" aria-label="На главную Sleep Diving" className="shrink-0">
            <BrandMark />
          </a>
        ...
        <div className="flex items-center gap-5 text-sd-muted max-sm:gap-4">
          <Button onClick={openConsultation} className="h-11 rounded-[6px] bg-sd-navy px-6 text-sm font-bold text-white shadow-[0_12px_28px_rgba(24,33,45,0.16)] transition hover:-translate-y-0.5 hover:bg-sd-navy/92 max-lg:hidden">
            Подобрать матрас
          </Button>
